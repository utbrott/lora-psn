...
void lora::shieldInit(lora::BoardType_t type, bool setupSensor)
{
    switch (type)
    {
    case SLAVE:
...
void lora::sendResponse(bme280::SensorData_t *data)
{
...
u8 lora::readResponse(lora::ReceivedData_t *data)
{
    u8 message[8]; // Payload
